...
!(function (t) {
    ...
    t.extend(t.fn, {
      ...
      rules: function (e, i) {
        ...
        if (e)
          switch (
            ((r = (s = t.data(h.form, "validator").settings).rules),
            ...
            case "add":
              t.extend(n, t.validator.normalizeRule(i)),
                ...
                (r[h.name] = n),
                i.messages &&
                  (s.messages[h.name] = t.extend(s.messages[h.name], i.messages));
              break;
            case "remove":
              return i
                ? ((l = {}),
        ...
        prototype: {
          ...
          elementValue: function (e) {
            ...
            return "radio" === r || "checkbox" === r
              ...
              ? !e.validity.badInput && s.val()
              : "string" == typeof (i = s.val())
              ? i.replace(/\r/g, "")
              : i;
          },
          check: function (e) {
