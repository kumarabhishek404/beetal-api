...
$numbers = array(
			__( 'Theme default (=50%)', 'avia_framework' )	=> ''
		);
...
$avia_elements[] = array(
			'slug'		=> 'header',
			'name'		=> __( 'Shrinking Amount', 'avia_framework' ),
			'desc'		=> __( 'Select a value to shrink the header. The bigger the value the smaller the header will be (ignored on smartphones + tablets)', 'avia_framework' ),
			'id'		=> 'header_shrinking_factor',
			'type'		=> 'select',
			'std'		=> '',
			'no_first'	=> true,
			'globalcss'	=> true,
			'required'	=> array( 'header_shrinking', 'header_shrinking' ),
			'subtype'	=> $numbers
		);
...
$avia_elements[] = array(
			'slug'		=> 'header',
			'name'		=> __( 'Reading Progress Bar', 'avia_framework' ),
			'desc'		=> __( 'Show a reading progress bar below header indicating vertical scroll position in document. Only available when top header and sticky header selected.', 'avia_framework' ),
			'id'		=> 'reading_progress',
			'type'		=> 'select',
			'std'		=> '',
			'no_first'	=> true,
//			'required'	=> array( 'header_position', '{contains}header_top' ),
			...
			'subtype'	=> array(
								...
								__( 'Show 2px bar', 'avia_framework' )	=> 'show small-bar',
								__( 'Show 4px bar', 'avia_framework' )	=> 'show medium-bar',
								__( 'Show 6px bar', 'avia_framework' )	=> 'show large-bar',
								__( 'Show 8px bar', 'avia_framework' )	=> 'show very-large-bar'
							)
		);

$avia_elements[] = array(
				'slug'		=> 'header',
				'name'		=> __( 'Reading Progress Bar Color', 'avia_framework' ),
				'desc'		=> __( 'Select a custom color for the reading progress bar. Leave empty for theme default.', 'avia_framework' ),
				'id'		=> 'reading_progress_color',
				'type'		=> 'colorpicker',
				'std'		=> '',
				'required'	=> array( 'reading_progress', '{contains}show' ),
				'globalcss'	=> true
			);
